...
from mate import constants, environment, wrappers, agents, utils
...
def make_environment(config=None, wrappers=(), **kwargs):  # pylint: disable=redefined-outer-name
    ...
    for wrapper in wrappers:
        assert isinstance(wrapper, WrapperSpec) or callable(wrapper) or issubclass(wrapper, gym.Wrapper), (
...
gym.register(id='MATE-4v2-9-v0', entry_point=make_environment,
             kwargs=dict(config=(ASSETS_DIR / 'MATE-4v2-9.yaml')))

gym.register(id='MATE-4v2-0-v0', entry_point=make_environment,
             kwargs=dict(config=(ASSETS_DIR / 'MATE-4v2-0.yaml')))

gym.register(id='MATE-4v4-9-v0', entry_point=make_environment,
             kwargs=dict(config=(ASSETS_DIR / 'MATE-4v4-9.yaml')))

gym.register(id='MATE-4v4-0-v0', entry_point=make_environment,
             kwargs=dict(config=(ASSETS_DIR / 'MATE-4v4-0.yaml')))

gym.register(id='MATE-4v8-9-v0', entry_point=make_environment,
             kwargs=dict(config=(ASSETS_DIR / 'MATE-4v8-9.yaml')))

gym.register(id='MATE-4v8-0-v0', entry_point=make_environment,
             kwargs=dict(config=(ASSETS_DIR / 'MATE-4v8-0.yaml')))

gym.register(id='MATE-8v8-9-v0', entry_point=make_environment,
             kwargs=dict(config=(ASSETS_DIR / 'MATE-8v8-9.yaml')))

gym.register(id='MATE-8v8-0-v0', entry_point=make_environment,
             kwargs=dict(config=(ASSETS_DIR / 'MATE-8v8-0.yaml')))

gym.register(id='MATE-Navigation-v0', entry_point=make_environment,
