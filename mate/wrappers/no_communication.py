...
class NoCommunication(MessageFilter):
    ...
    def __init__(self, env: MateEnvironmentType, team: Literal['both', 'camera', 'target', 'none'] = 'both') -> None:
        ...
        if self.team == 'both':
            ...
            super().__init__(env, filter=lambda unwrapped, message: message.team.name.lower() != self.team)
