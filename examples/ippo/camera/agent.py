...
import mate
from examples.ippo.camera.config import config as _config
from examples.ippo.camera.config import make_env as _make_env
from examples.utils import RLlibPolicyMixIn


class IPPOCameraAgent(RLlibPolicyMixIn, mate.CameraAgentBase):
    """IPPO Camera Agent
