...
import mate
from examples.ippo.target.config import config as _config
from examples.ippo.target.config import make_env as _make_env
from examples.utils import RLlibPolicyMixIn


class IPPOTargetAgent(RLlibPolicyMixIn, mate.TargetAgentBase):
    """IPPO Target Agent
