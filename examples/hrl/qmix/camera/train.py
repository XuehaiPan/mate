...
# Run: python3 -m examples.hrl.qmix.camera.train
...
def train(
    ...
    seed=None, timesteps_total=None, buffer_capacity=2000
):
    ...
    if WandbLoggerCallback.is_available():
        ...
        group = group or f'hrl.qmix.camera.{experiment.name}'
...
def main():
    ...
    parser.add_argument('--buffer-capacity', type=float, metavar='EPISODE', default=2000,
