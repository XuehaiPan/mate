...
.. code:: bash
    ...
    python3 -m examples.i2c.camera

    python3 -m mate.evaluate --episodes 1 --render-communication \
        --camera-agent examples.i2c:I2CCameraAgent \
        --camera-kwargs '{ "checkpoint_path": "examples/i2c/camera/ray_results/I2C/latest-checkpoint" }'
"""
...
from examples.i2c.camera.train import experiment
...
def main():
    ...
    if not os.path.exists(args.checkpoint_path):
        print(
            (
                ...
                f'  python -m examples.i2c.camera.train'
            ),
            file=sys.stderr,
        )
        sys.exit(1)
    ...
    # Make agents ##############################################################
    camera_agent = I2CCameraAgent(checkpoint_path=args.checkpoint_path)
