...
import mate
from examples.qmix.camera.config import config as _config
from examples.qmix.camera.config import make_env as _make_env
from examples.utils import RLlibGroupedPolicyMixIn


class QMIXCameraAgent(RLlibGroupedPolicyMixIn, mate.CameraAgentBase):
    """QMIX Camera Agent
