...
.. code:: bash
    ...
    python3 -m mate.evaluate --episodes 1 --render-communication \
        ...
        --target-kwargs '{ "checkpoint_path": "examples/mappo/target/ray_results/MAPPO/latest-checkpoint" }'
"""
...
def main():
    ...
    target_agent = MAPPOTargetAgent(checkpoint_path=args.checkpoint_path)
