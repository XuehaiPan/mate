...
import mate
from examples.iql.camera.config import config as _config
from examples.iql.camera.config import make_env as _make_env
from examples.utils import RLlibPolicyMixIn


class IQLCameraAgent(RLlibPolicyMixIn, mate.CameraAgentBase):
    """IQL Camera Agent
