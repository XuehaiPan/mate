...
from examples.tarmac.target.config import config as _config
from examples.tarmac.target.config import make_env as _make_env
from examples.utils import RLlibPolicyMixIn


class TarMACTargetAgent(RLlibPolicyMixIn, mate.TargetAgentBase):
    """TarMAC Target Agent
